...
/**
 * La clase DirectorDAO implementa las operaciones CRUD (Crear, Leer, Actualizar, Eliminar)
 * para los objetos DirectorDTO y Director. Esta clase maneja la persistencia de datos de los directores
...
public class DirectorDAO implements CRUDOperation<DirectorDTO, Director> {
    ...
    /**
     * Constructor que inicializa el DirectorDAO, verifica las carpetas y lee los datos serializados.
     */
    public DirectorDAO() {
     ...
     * 
     * @return Un string con los detalles de todos los directores, o un mensaje indicando que no hay directores.
     */
    @Override
     ...
     * 
     * @param newData El objeto DirectorDTO con los datos del nuevo director a agregar.
     ...
     * @return true si el director fue eliminado correctamente, false si no se encontró.
     */
    @Override
     ...
     * @return true si el director fue actualizado correctamente, false si no se encontró.
     */
    @Override
    ...
    /**
     * Lee los datos de los directores desde un archivo CSV y los almacena en la lista de directores.
     */
    @Override
    ...
    /**
     * Lee los datos de los directores desde un archivo serializado y los almacena en la lista de directores.
     */
     ...
     * 
     * @param id El ID del director.
     * @param esNombre true si se desea obtener el nombre, false si se desea obtener el correo.
