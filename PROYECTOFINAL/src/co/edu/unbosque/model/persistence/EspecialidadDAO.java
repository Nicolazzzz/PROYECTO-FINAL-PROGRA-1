...
/**
 * La clase EspecialidadDAO implementa las operaciones CRUD (Crear, Leer, Actualizar, Eliminar)
 * para los objetos EspecialidadDTO y Especialidad. Esta clase maneja la persistencia de datos de las especialidades
...
public class EspecialidadDAO implements CRUDOperation<EspecialidadDTO, Especialidad> {
    ...
    /**
     * Constructor que inicializa el EspecialidadDAO, verifica las carpetas y lee los datos serializados.
     */
     ...
     * 
     * @return Un string con los detalles de todas las especialidades, o un mensaje indicando que no hay especialidades.
     */
    @Override
     ...
     * 
     * @return Una lista de objetos EspecialidadDTO con todos los datos de las especialidades.
     */
     ...
     * 
     * @param newData El objeto EspecialidadDTO con los datos de la nueva especialidad a agregar.
     * @return true si la especialidad fue añadida correctamente, false si ya existe.
     */
    @Override
     ...
     * 
     * @param toDelete El objeto EspecialidadDTO que representa la especialidad a eliminar.
     * @return true si la especialidad fue eliminada correctamente, false si no se encontró.
     */
    @Override
     ...
     * 
     * @param previous El objeto EspecialidadDTO con los datos anteriores de la especialidad.
     * @param newData El objeto EspecialidadDTO con los nuevos datos de la especialidad.
     * @return true si la especialidad fue actualizada correctamente, false si no se encontró.
     */
    @Override
    ...
    /**
     * Lee los datos de las especialidades desde un archivo CSV y los almacena en la lista de especialidades.
     */
    @Override
    ...
    /**
     * Lee los datos de las especialidades desde un archivo serializado y los almacena en la lista de especialidades.
     */
     ...
     * 
     * @return Un arreglo de cadenas con los nombres de las especialidades, o un mensaje si no hay especialidades.
     */
