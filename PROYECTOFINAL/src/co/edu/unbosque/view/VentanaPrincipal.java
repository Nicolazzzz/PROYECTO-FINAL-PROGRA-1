 ...
 * de la aplicación. Se encarga de mostrar distintos paneles según la interacción 
 * del usuario, como la pantalla de bienvenida, la pantalla de inicio de sesión, 
 * y las pantallas de inicio de director, especialista, paciente y apartado.
...
public class VentanaPrincipal extends JFrame {
     ...
     * Inicializa la ventana principal con su tamaño, título, icono y paneles 
    ...
    public void mostrarPanelHomePaciente() {
        setContentPane(panelHDirector); // Se muestra PanelHomeDirector en lugar de PanelHomePaciente
    }
